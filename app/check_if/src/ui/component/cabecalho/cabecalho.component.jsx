    ...
    return (
        <>
            <header className='cabecalho'>
                ...
                <img src={usuarioImg} alt='usuario' className='usuario-icone' onClick={() => { setMostrarBarraLateral(!mostrarBarraLateral) }} />

                <img src={logo} alt='Check-IF' className='logo-icone' onClick={() => {navigate("/home")}} />
                ...
                <div className='container-pesquisar-sair'>
                    ...
                    {usuario.permissao
                        ...
                        <form className='form-pesquisar' onSubmit={onSubmit}>
                            ...
                            Pesquise o aluno aqui<br />
                            <label className='label-pesquisar'>
                                <input type='search' name="aluno" className='input-pesquisar-aluno' 
                                    onChange={handleChange} required />
                                <button className='botao-pesquisar'><img src={lupa} alt='Lupa' className='lupa-icone' /></button>
                            </label>
            ...
            <div className={mostrarBarraLateral ? "barra-lateral" : "barra-lateral invisivel"}>
                ...
                <span className='acoes-perfil'>
                    ...
                    {usuario.permissao === "ADMINISTRADOR"
                        ?
                        <>
                            <button className='botao-acao' onClick={() => {navigate("/home")}}>
                            ...
                            <button className='botao-acao'>
                                <img src={vincular} alt="Usuário" className='icone-acao' />
                                Cadastrar usuário
                            </button>

                            <button className='botao-acao'>
                                <img src={notificacao} alt="Notificação" className='icone-acao' />
