...
import { Borda, LogoInicial, TituloTelasIniciais, Botao } from '../../component';
                    ...
                    <span>
                        ...
                        <div className="input-senha-alterar">
                            <input
                                ...
                                autoComplete='off'
                            />
                            <img onClick={mostrarSenha} src={senhas.senha ? olhoAberto : olhoFechado}
                                alt={"Olho"} className="imagem-input" id="senha" />
                        </div>
                    </span>
                    ...
                    <span>
                        ...
                        <div className="input-senha-alterar">
                            <input
                                ...
                                autoComplete='off'
                            />
                            <img onClick={mostrarSenha} src={senhas.confirmarSenha ? olhoAberto : olhoFechado}
                                alt={"Olho"} className="imagem-input" id="confirmarSenha" />
                        </div>
                    </span>
