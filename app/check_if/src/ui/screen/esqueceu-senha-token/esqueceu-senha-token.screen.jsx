    ...
    return (
        <section className="section-tela-esqueceu-senha-token">
            ...
            <main className='tela-esqueceu-senha-token'>
                ...
                <TituloTelasIniciais>Digite o código de verificação</TituloTelasIniciais>

                <span>
                    <h2 className="legenda-tela-esqueceu-senha-token">Código de verificação enviado para o e-mail {usuario?.email}</h2>
                    <h3 className="legenda-reenviar-codigo" onClick={reenviarCodigo}>Clique aqui para reenviar o código</h3>
                </span>

                <form className="form-esqueceu-senha" onSubmit={onSubmit}>

                    <InputEspecifico imagem={verificacao} alt="Verificação" type="text" name="token" placeholder="Código de verificação"
