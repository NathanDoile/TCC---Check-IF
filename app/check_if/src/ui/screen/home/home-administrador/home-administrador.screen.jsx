...
export function TelaHomeAdministrador() {
    ...
    useEffect(() => {
        ...
        chegadasAtrasadas.forEach(c => {
            ...
            setChegadasAtrasadasTag((oldChegadasAtrasadasTag) => ([...oldChegadasAtrasadasTag,
            <ChegadaAtrasada nome={c.nome} turma={c.turma} matricula={c.matricula}
            ...
            <main className='tela-home-administrador'>
                ...
                <div className='cabecalho-chegadas-atrasadas'>
                    ...
                    <span className='input-adicionar-registro'>
                        <img src={adicionar} alt='Adicionar' className='imagem-adicionar' 
                            onClick={() => {setRegistrarOcorrencia(!registrarOcorrencia)}} />

                        {registrarOcorrencia 
                        ? 
                            <span className='botoes-registrar'>
                                <button className='botao-registrar' onClick={() => {navigate("/administrador/registrar-chegada")}}>Chegada atrasada</button>
                                <button className='botao-registrar'>Saída antecipada</button>
                            </span>
                        : <span>Cadastre ocorrências</span>}
                        
                    </span>

                    <h1 className='titulo-chegadas-atrasadas'>Histórico de chegadas atrasadas</h1>

                    <form>
                        <input type="date" name="data" className="input-data" defaultValue={hoje}
