        ...
        <>
            ...
            <main className="main-home-responsavel">
                ...
                <form className="form-saida-antecipada">
                    ...
                    <Input isSelect legenda="Aluno" isObrigatorio name="aluno" handleChange={handleChange}
                        opcoes={["Nathan de Souza Doile", "Emily Aparecida da Silveira Eberhardt"]} values={[1, 2]}
                        grande />

                    <span className='inputs-solicitar-saida'>

                        <Input legenda="Data" isObrigatorio name="data" handleChange={handleChange} type="date" />

                        <Input legenda="Hora" isObrigatorio name="hora" handleChange={handleChange} type="time" />
