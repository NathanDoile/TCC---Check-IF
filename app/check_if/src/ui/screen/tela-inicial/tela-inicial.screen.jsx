  ...
  return (
    <section className="section-tela-inicial">
      ...
      <main className="tela-inicial">
        ...
        <TituloTelasIniciais>Boas vindas ao Check-IF</TituloTelasIniciais>

        <h2 className="descricao-botao-tela-inicial">
          Registre sua chegada atrasada aqui!
        </h2>

        <Botao onClick={botaoRegistrarChegada} cor="verde">
          Registrar
        </Botao>
        ...
        <div className="ou-barras-tela-inicial">
          <img
            src={barra}
            className="barra-esquerda-tela-inicial"
            alt="barra"
          />
        ...
        <h2 className="descricao-botao-tela-inicial">
          Se você for usuário, realize seu login aqui!
        </h2>

        <Botao onClick={botaoLogin} cor="verde">
          Login
        </Botao>
      </main>
