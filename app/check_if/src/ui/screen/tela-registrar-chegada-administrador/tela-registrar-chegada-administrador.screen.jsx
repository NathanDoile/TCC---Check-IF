...
export function TelaRegistrarChegadaAdministrador() {
    ...
    async function registrarChegada(event) {
        ...
        if (
            ...
            await registrarChegadaManual(formInput.motivo, formInput.disciplina, formInput.matricula, formInput.professor);
        }
    }
    ...
    return (
        <>
            ...
            <main className='main-tela-registrar-chegada-adm'>
                ...
                <form onSubmit={registrarChegada} className='form-registrar-chegada-atrasada-adm'>

                    <Input isSelect={false} legenda="Matrícula do aluno" isObrigatorio={true} name="matricula" handleChange={handleChange}
                        type="text" grande={true} />

                    <span className='inputs-form-registrar-chegada-adm'>
                        <Input isSelect={true} legenda="Professor" isObrigatorio={true} name="professor" handleChange={handleChange}
                            opcoes={nomesProfessores} values={idsProfessores} />

                        <Input isSelect={false} legenda={"Disciplina"} isObrigatorio={false} name={"disciplina"} handleChange={handleChange}
                            type={"text"} grande={false} />
                    </span>

                    <span className='inputs-form-registrar-chegada-adm'>
                        <Input isSelect={true} legenda="Motivo" isObrigatorio={true} name="motivo" handleChange={handleChange}
                            opcoes={motivos} values={motivos} />

                        {outroMotivo 
                        ? <Input isSelect={false} legenda={"Outro"} isObrigatorio={true} name={"outroMotivo"} handleChange={handleChange}
                        type={"text"} grande={false} />
                        : null}
                    </span>

                    <span className='botao-form-registrar-chegada-adm'><Botao cor={"laranja"}>Registrar</Botao></span>
